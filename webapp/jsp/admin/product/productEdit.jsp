...
<body>
<form name="productForm" id="productForm" method="post" action="productAction!editSave.${actionExt}" onsubmit="return checkForm();">
<table cellpadding="0" cellspacing="0" class="l-table-edit" style="margin-top:50px;margin-left:50px;">
    <input type="hidden" id="product.id" name="product.id" value="${requestScope.product.id}"/>
    <tr>
        <td align="right" class="l-table-edit-td">名称：</td>
        <td align="left" class="l-table-edit-td"><input name="product.name" type="text" id="product.name" ltype="text" value="${requestScope.product.name}"/></td>
        <td align="left"></td>
    </tr>
    <tr>
        <td align="right" class="l-table-edit-td">短名称：</td>
        <td align="left" class="l-table-edit-td"><input name="product.shortName" type="text" id="product.shortName" ltype="text" value="${requestScope.product.shortName}"/></td>
        <td align="left"></td>
    </tr>
    <tr>
        ...
        <textarea name="product.content" id="product.content" cols="80" rows="8" 
    			style="width:680px;height:350px;visibility:hidden;">${requestScope.product.content}</textarea>
    			</td>
        <td align="left"></td>
    </tr>
    <tr>
