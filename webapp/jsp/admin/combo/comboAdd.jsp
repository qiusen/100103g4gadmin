...
<body>
<form name="comboForm" id="comboForm" method="post" action="comboAction!addSave.${actionExt}" onsubmit="return checkForm();">
<table cellpadding="0" cellspacing="0" class="l-table-edit" style="margin-top:50px;margin-left:50px;">
    <tr>
    	<td align="right" class="l-table-edit-td">名称：</td>
    	<td align="left" class="l-table-edit-td"><input name="combo.name" type="text" id="combo.name" ltype="text" /></td>
    	<td align="left"></td>
    </tr>
    <tr>
    	<td align="right" class="l-table-edit-td">短名称：</td>
    	<td align="left" class="l-table-edit-td"><input name="combo.shortName" type="text" id="combo.shortName" ltype="text" /></td>
    	<td align="left"></td>
    </tr>
    <tr>
