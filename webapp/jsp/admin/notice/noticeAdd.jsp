...
<body>
<form name="noticeForm" id="noticeForm" method="post" action="noticeAction!addSave.${actionExt}" onsubmit="return checkForm();">
<table cellpadding="0" cellspacing="0" class="l-table-edit" style="margin-top:50px;margin-left:50px;">
    <tr>
    	<td align="right" class="l-table-edit-td">标题：</td>
    	<td align="left" class="l-table-edit-td"><input name="notice.title" type="text" id="notice.title" ltype="text" /></td>
    	<td align="left"></td>
    </tr>
    <tr>
