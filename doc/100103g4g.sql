...
values('qiusen','邱森','13800138000','-','-','-','A','123456789123456789',1,'香港','邱森','1234567890123456','21232f297a57a5a743894a0e4a801fc3','21232f297a57a5a743894a0e4a801fc3','21232f297a57a5a743894a0e4a801fc3','13900139000','297454210','100080','北京市海淀区中关村','这个就不写了',0.00,0.00,0.00,'',1,0,0,'-','2012-08-01 08:08:08','-','2012-08-01 08:08:08','-','2012-08-01 08:08:08');
...
DROP TABLE IF EXISTS CASH_TAX CASCADE;
CREATE TABLE `CASH_TAX` (
  `ID` int(11) NOT NULL auto_increment,
  `CODE` varchar(255) NOT NULL COMMENT '编号',
  `COIN` double default 0.00 COMMENT '转换金额',
  `DEALTIME` datetime default '2000-01-01 00:00:00' COMMENT '结算时间',
  PRIMARY KEY  (`ID`)
